...
public class Driver 
{
	...
	{
		for(int i = 0; i < row1.length; i = i + 1)
		{
			if(row[i] == '_')
			{
	...
	//static makes this a class function
...
*		//memory-> variables
		...
		int[] ar = new int[10]; // empty array that i can add to things to
		ar[0] = 5;
		ar[1] = 6;
		int[] ar2 = {1,2,7,14};
		ar2[1] = -5;
